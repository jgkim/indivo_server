...
def create_and_load_from(filepath):
    if not os.path.isfile(filepath):
        print "Can't load the problem statuses, the file does not exist at %s" % filepath
        return

    vocabulary = create_vocabulary('problem-status',
      'Problem Status',
      'Status of this problem, using a SNOMED CT code',
