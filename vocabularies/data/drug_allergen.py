...
def create_and_load_from(filepath):
    if not os.path.isfile(filepath):
        print "Can't load drug allergens, the file does not exist at %s" % filepath
        return
    
    vocabulary = create_vocabulary('drug-allergen', 'Drug Allergen', "RxNorm Concept at the ingredient level (TTY='in')")
