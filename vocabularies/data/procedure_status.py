...
def create_and_load_from(filepath):
    if not os.path.isfile(filepath):
        print "Can't load the procedure statuses, the file does not exist at %s" % filepath
        return

    vocabulary = create_vocabulary('procedure-status',
      'Procedure Status',
      'Status of procedure, using a SNOMED CT code',
