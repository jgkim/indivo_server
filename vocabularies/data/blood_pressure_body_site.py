"""
Blood Pressure Body Sites loading
...
def create_and_load_from(filepath):
    if not os.path.isfile(filepath):
        print "Can't load the blood pressure body sites, the file does not exist at %s" % filepath
        return

    vocabulary = create_vocabulary('blood-pressure-body-site',
      'Blood Pressure Body Site',
      "Site on consumer's body where blood pressure was recorded,  using a SMART Platforms' sp: BloodPressureBodySite code",
