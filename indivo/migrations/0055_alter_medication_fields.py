...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'Medication.startDate' field to 'Medication.start_date'
        db.rename_column('indivo_medication', 'startDate', 'start_date')

        # Rename 'Medication.endDate' field to 'Medication.end_date'
        db.rename_column('indivo_medication', 'endDate', 'end_date')

        # Adding field 'Medication.notes'
        db.add_column('indivo_medication', 'notes',
                      self.gf('django.db.models.fields.CharField')(max_length=600, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Rename 'Medication.start_date' field to 'Medication.startDate'
        db.rename_column('indivo_medication', 'start_date', 'startDate')

        # Rename 'Medication.end_date' field to 'Medication.endDate'
        db.rename_column('indivo_medication', 'end_date', 'endDate')

        # Deleting field 'Medication.notes'
        db.delete_column('indivo_medication', 'notes')
