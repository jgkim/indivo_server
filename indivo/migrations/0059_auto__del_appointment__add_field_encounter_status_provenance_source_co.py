...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Encounter.status_provenance_source_code'
        db.add_column('indivo_encounter', 'status_provenance_source_code',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_prov_sc', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.status_provenance_translation_fidelity'
        db.add_column('indivo_encounter', 'status_provenance_translation_fidelity',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_prov_tf', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.status_provenance_title'
        db.add_column('indivo_encounter', 'status_provenance_title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_prov_title', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.status_code_identifier'
        db.add_column('indivo_encounter', 'status_code_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_code_id', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.status_code_system'
        db.add_column('indivo_encounter', 'status_code_system',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_code_sys', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.status_code_title'
        db.add_column('indivo_encounter', 'status_code_title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_code_title', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.status_title'
        db.add_column('indivo_encounter', 'status_title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_title', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.specialty_provenance_source_code'
        db.add_column('indivo_encounter', 'specialty_provenance_source_code',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_prov_sc', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.specialty_provenance_translation_fidelity'
        db.add_column('indivo_encounter', 'specialty_provenance_translation_fidelity',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_prov_tf', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.specialty_provenance_title'
        db.add_column('indivo_encounter', 'specialty_provenance_title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_prov_title', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.specialty_code_identifier'
        db.add_column('indivo_encounter', 'specialty_code_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_code_id', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.specialty_code_system'
        db.add_column('indivo_encounter', 'specialty_code_system',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_code_sys', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.specialty_code_title'
        db.add_column('indivo_encounter', 'specialty_code_title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_code_title', blank=True),
                      keep_default=False)

        # Adding field 'Encounter.specialty_title'
        db.add_column('indivo_encounter', 'specialty_title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_title', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('indivo_appointment', (
            ('appointment_type_provenance_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='appointment_type_prov_title', blank=True)),
            ('specialty_provenance_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_prov_title', blank=True)),
            ...
            ('status_code_identifier', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_code_id', blank=True)),
            ('specialty_code_system', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_code_sys', blank=True)),
            ('facility_adr_city', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='facility_adr_city', blank=True)),
            ...
            ('specialty_code_identifier', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_code_id', blank=True)),
            ...
            ('appointment_type_code_system', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='appointment_type_code_sys', blank=True)),
            ...
            ('specialty_provenance_source_code', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_prov_sc', blank=True)),
            ...
            ('facility_adr_country', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='facility_adr_country', blank=True)),
            ('status_provenance_translation_fidelity', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_prov_tf', blank=True)),
            ...
            ('specialty_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_title', blank=True)),
            ('status_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_title', blank=True)),
            ...
            ('appointment_type_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='appointment_type_title', blank=True)),
            ...
            ('appointment_type_provenance_translation_fidelity', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='appointment_type_prov_tf', blank=True)),
            ...
            ('appointment_type_code_identifier', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='appointment_type_code_id', blank=True)),
            ('facility_adr_region', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='facility_adr_region', blank=True)),
            ('fact_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['indivo.Fact'], unique=True, primary_key=True)),
            ('status_provenance_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_prov_title', blank=True)),
            ('status_provenance_source_code', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_prov_sc', blank=True)),
            ('appointment_type_code_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='appointment_type_code_title', blank=True)),
            ('specialty_code_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_code_title', blank=True)),
            ('facility_adr_street', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='facility_adr_street', blank=True)),
            ...
            ('facility_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='facility_name', blank=True)),
            ('appointment_type_provenance_source_code', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='appointment_type_prov_sc', blank=True)),
            ...
            ('specialty_provenance_translation_fidelity', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='specialty_prov_tf', blank=True)),
            ('status_code_system', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_code_sys', blank=True)),
            ...
            ('status_code_title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_code_title', blank=True)),
            ...
            ('facility_adr_postalcode', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, db_column='facility_adr_postalcode', blank=True)),
        ))
        db.send_create_signal('indivo', ['Appointment'])

        # Deleting field 'Encounter.status_provenance_source_code'
        db.delete_column('indivo_encounter', 'status_prov_sc')

        # Deleting field 'Encounter.status_provenance_translation_fidelity'
        db.delete_column('indivo_encounter', 'status_prov_tf')

        # Deleting field 'Encounter.status_provenance_title'
        db.delete_column('indivo_encounter', 'status_prov_title')

        # Deleting field 'Encounter.status_code_identifier'
        db.delete_column('indivo_encounter', 'status_code_id')

        # Deleting field 'Encounter.status_code_system'
        db.delete_column('indivo_encounter', 'status_code_sys')

        # Deleting field 'Encounter.status_code_title'
        db.delete_column('indivo_encounter', 'status_code_title')

        # Deleting field 'Encounter.status_title'
        db.delete_column('indivo_encounter', 'status_title')

        # Deleting field 'Encounter.specialty_provenance_source_code'
        db.delete_column('indivo_encounter', 'specialty_prov_sc')

        # Deleting field 'Encounter.specialty_provenance_translation_fidelity'
        db.delete_column('indivo_encounter', 'specialty_prov_tf')

        # Deleting field 'Encounter.specialty_provenance_title'
        db.delete_column('indivo_encounter', 'specialty_prov_title')

        # Deleting field 'Encounter.specialty_code_identifier'
        db.delete_column('indivo_encounter', 'specialty_code_id')

        # Deleting field 'Encounter.specialty_code_system'
        db.delete_column('indivo_encounter', 'specialty_code_sys')

        # Deleting field 'Encounter.specialty_code_title'
        db.delete_column('indivo_encounter', 'specialty_code_title')

        # Deleting field 'Encounter.specialty_title'
        db.delete_column('indivo_encounter', 'specialty_title')
    ...
    models = {
        ...
        'indivo.encounter': {
            ...
            'provider_tel_2_preferred_p': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'provider_tel_2_preferred_p'"}),
            'provider_tel_2_type': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'db_column': "'provider_tel_2_type'", 'blank': 'True'}),
            'specialty_code_identifier': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'db_column': "'specialty_code_id'", 'blank': 'True'}),
            'specialty_code_system': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'db_column': "'specialty_code_sys'", 'blank': 'True'}),
            'specialty_code_title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'db_column': "'specialty_code_title'", 'blank': 'True'}),
            'specialty_provenance_source_code': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'db_column': "'specialty_prov_sc'", 'blank': 'True'}),
            'specialty_provenance_title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'db_column': "'specialty_prov_title'", 'blank': 'True'}),
            'specialty_provenance_translation_fidelity': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'db_column': "'specialty_prov_tf'", 'blank': 'True'}),
            'specialty_title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'db_column': "'specialty_title'", 'blank': 'True'}),
        ...
        'indivo.vitalsigns': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'encounter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'vital_signs'", 'null': 'True', 'to': "orm['indivo.Encounter']"}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
