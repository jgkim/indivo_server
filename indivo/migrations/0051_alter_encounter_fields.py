...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'Encounter.type_code_title' field to 'Encounter.encounter_type_code_title'
        db.rename_column('indivo_encounter', 'type_code_title', 'encounter_type_code_title')

        # Rename 'Encounter.type_provenance_source_code' field to 'Encounter.encounter_type_provenance_source_code'
        db.rename_column('indivo_encounter', 'type_prov_sc', 'encounter_type_prov_sc')

        # Rename 'Encounter.type_code_identifier' field to 'Encounter.encounter_type_code_identifier'
        db.rename_column('indivo_encounter', 'type_code_id', 'encounter_type_code_id')

        # Rename 'Encounter.type_code_system' field to 'Encounter.encounter_type_code_system'
        db.rename_column('indivo_encounter', 'type_code_sys', 'encounter_type_code_sys')

        # Rename 'Encounter.type_provenance_title' field to 'Encounter.encounter_type_provenance_title'
        db.rename_column('indivo_encounter', 'type_prov_title', 'encounter_type_prov_title')

        # Rename 'Encounter.type_title' field to 'Encounter.encounter_type_title'
        db.rename_column('indivo_encounter', 'type_title', 'encounter_type_title')

        # Rename 'Encounter.type_provenance_translation_fidelity' field to 'Encounter.encounter_type_provenance_translation_fidelity'
        db.rename_column('indivo_encounter', 'type_prov_tf', 'encounter_type_prov_tf')

        # Rename 'Encounter.startDate' field to 'Encounter.start_date'
        db.rename_column('indivo_encounter', 'startDate', 'start_date')

        # Rename 'Encounter.endDate' field to 'Encounter.end_date'
        db.rename_column('indivo_encounter', 'endDate', 'end_date')

        # Adding field 'Encounter.notes'
        db.add_column('indivo_encounter', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Rename 'Encounter.encounter_type_code_title' field to 'Encounter.type_code_title'
        db.rename_column('indivo_encounter', 'encounter_type_code_title', 'type_code_title')

        # Rename 'Encounter.encounter_type_provenance_source_code' field to 'Encounter.type_provenance_source_code'
        db.rename_column('indivo_encounter', 'encounter_type_prov_sc', 'type_prov_sc')

        # Rename 'Encounter.encounter_type_code_identifier' field to 'Encounter.type_code_identifier'
        db.rename_column('indivo_encounter', 'encounter_type_code_id', 'type_code_id')

        # Rename 'Encounter.encounter_type_code_system' field to 'Encounter.type_code_system'
        db.rename_column('indivo_encounter', 'encounter_type_code_sys', 'type_code_sys')

        # Rename 'Encounter.encounter_type_provenance_title' field to 'Encounter.type_provenance_title'
        db.rename_column('indivo_encounter', 'encounter_type_prov_title', 'type_prov_title')

        # Rename 'Encounter.encounter_type_title' field to 'Encounter.type_title'
        db.rename_column('indivo_encounter', 'encounter_type_title', 'type_title')

        # Rename 'Encounter.encounter_type_provenance_translation_fidelity' field to 'Encounter.type_provenance_translation_fidelity'
        db.rename_column('indivo_encounter', 'encounter_type_prov_tf', 'type_prov_tf')

        # Rename 'Encounter.start_date' field to 'Encounter.startDate'
        db.rename_column('indivo_encounter', 'start_date', 'startDate')

        # Rename 'Encounter.end_date' field to 'Encounter.endDate'
        db.rename_column('indivo_encounter', 'end_date', 'endDate')

        # Deleting field 'Encounter.notes'
        db.delete_column('indivo_encounter', 'notes')
