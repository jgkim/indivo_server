...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'Problem.startDate' field to 'Problem.start_date'
        db.rename_column('indivo_problem', 'startDate', 'start_date')

        # Rename 'Problem.endDate' field to 'Problem.end_date'
        db.rename_column('indivo_problem', 'endDate', 'end_date')

        # Adding field 'Problem.stop_reason'
        db.add_column('indivo_problem', 'stop_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Problem.status_provenance_source_code'
        db.add_column('indivo_problem', 'status_provenance_source_code',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_prov_sc', blank=True),
                      keep_default=False)

        # Adding field 'Problem.status_provenance_translation_fidelity'
        db.add_column('indivo_problem', 'status_provenance_translation_fidelity',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_prov_tf', blank=True),
                      keep_default=False)

        # Adding field 'Problem.status_provenance_title'
        db.add_column('indivo_problem', 'status_provenance_title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_prov_title', blank=True),
                      keep_default=False)

        # Adding field 'Problem.status_code_identifier'
        db.add_column('indivo_problem', 'status_code_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_code_id', blank=True),
                      keep_default=False)

        # Adding field 'Problem.status_code_system'
        db.add_column('indivo_problem', 'status_code_system',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_code_sys', blank=True),
                      keep_default=False)

        # Adding field 'Problem.status_code_title'
        db.add_column('indivo_problem', 'status_code_title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_code_title', blank=True),
                      keep_default=False)

        # Adding field 'Problem.status_title'
        db.add_column('indivo_problem', 'status_title',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, db_column='status_title', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Rename 'Problem.start_date' field to 'Problem.startDate'
        db.rename_column('indivo_problem', 'start_date', 'startDate')

        # Rename 'Problem.end_date' field to 'Problem.endDate'
        db.rename_column('indivo_problem', 'end_date', 'endDate')

        # Deleting field 'Problem.stop_reason'
        db.delete_column('indivo_problem', 'stop_reason')

        # Deleting field 'Problem.status_provenance_source_code'
        db.delete_column('indivo_problem', 'status_prov_sc')

        # Deleting field 'Problem.status_provenance_translation_fidelity'
        db.delete_column('indivo_problem', 'status_prov_tf')

        # Deleting field 'Problem.status_provenance_title'
        db.delete_column('indivo_problem', 'status_prov_title')

        # Deleting field 'Problem.status_code_identifier'
        db.delete_column('indivo_problem', 'status_code_id')

        # Deleting field 'Problem.status_code_system'
        db.delete_column('indivo_problem', 'status_code_sys')

        # Deleting field 'Problem.status_code_title'
        db.delete_column('indivo_problem', 'status_code_title')

        # Deleting field 'Problem.status_title'
        db.delete_column('indivo_problem', 'status_title')
