...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Encounter.notes'
        db.alter_column('indivo_encounter', 'notes', self.gf('django.db.models.fields.CharField')(max_length=600, null=True))

        # Changing field 'Problem.notes'
        db.alter_column('indivo_problem', 'notes', self.gf('django.db.models.fields.CharField')(max_length=600, null=True))
        # Adding field 'VitalSigns.notes'
        db.add_column('indivo_vitalsigns', 'notes',
                      self.gf('django.db.models.fields.CharField')(max_length=600, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Allergy.notes'
        db.alter_column('indivo_allergy', 'notes', self.gf('django.db.models.fields.CharField')(max_length=600, null=True))

    def backwards(self, orm):

        # Changing field 'Encounter.notes'
        db.alter_column('indivo_encounter', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Problem.notes'
        db.alter_column('indivo_problem', 'notes', self.gf('django.db.models.fields.TextField')(null=True))
        # Deleting field 'VitalSigns.notes'
        db.delete_column('indivo_vitalsigns', 'notes')


        # Changing field 'Allergy.notes'
        db.alter_column('indivo_allergy', 'notes', self.gf('django.db.models.fields.TextField')(null=True))
