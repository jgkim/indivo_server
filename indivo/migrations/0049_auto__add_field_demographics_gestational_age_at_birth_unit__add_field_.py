...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demographics.gestational_age_at_birth_unit'
        db.add_column('indivo_demographics', 'gestational_age_at_birth_unit',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='gestational_age_at_birth_unit', blank=True),
                      keep_default=False)

        # Adding field 'Demographics.gestational_age_at_birth_value'
        db.add_column('indivo_demographics', 'gestational_age_at_birth_value',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='gestational_age_at_birth_value', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demographics.gestational_age_at_birth_unit'
        db.delete_column('indivo_demographics', 'gestational_age_at_birth_unit')

        # Deleting field 'Demographics.gestational_age_at_birth_value'
        db.delete_column('indivo_demographics', 'gestational_age_at_birth_value')
