...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Procedure.notes'
        db.alter_column('indivo_procedure', 'notes', self.gf('django.db.models.fields.CharField')(max_length=600, null=True))

    def backwards(self, orm):

        # Changing field 'Procedure.notes'
        db.alter_column('indivo_procedure', 'notes', self.gf('django.db.models.fields.TextField')(null=True))
